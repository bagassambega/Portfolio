                ...
                <div className="flex flex-wrap items-center gap-4">
                  {project.url && (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full border-2 border-border text-sm hover:bg-blue-500 hover:text-white hover:border-blue-500 transition-all"
                    >
                  ...
                  {project.sourcecode && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full border-2 border-border text-sm hover:bg-foreground hover:text-background hover:border-foreground transition-all"
                    >
                      <svg
                        role="img"
                        viewBox="0 0 24 24"
